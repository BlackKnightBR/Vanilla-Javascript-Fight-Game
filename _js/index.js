...
const player = new Fighter({
  ...
  sprites: {
    ...
    attack1: {
      imageSrc: './_imagens/samuraiMack/Attack1.png',
      framesMax: 6
    },
    takeHit: {
      imageSrc: './_imagens/samuraiMack/Take Hit - white silhouette.png',
      framesMax: 4
    },
    death: {
      imageSrc: './_imagens/samuraiMack/Death.png',
      framesMax: 6
    }
  },
  attackBox: {
...
const enemy = new Fighter({
  ...
  sprites: {
    ...
    run: {
      imageSrc: './_imagens/kenji/Run.png',
      framesMax: 8
    },
    jump: {
      imageSrc: './_imagens/kenji/Jump.png',
      framesMax: 2
    },
    fall: {
      imageSrc: './_imagens/kenji/Fall.png',
      framesMax: 2
    },
    attack1: {
      imageSrc: './_imagens/kenji/Attack1.png',
      framesMax: 4
    },
    takeHit: {
      imageSrc: './_imagens/kenji/Take hit.png',
      framesMax: 3
    },
    death: {
      imageSrc: './_imagens/kenji/Death.png',
      framesMax: 7
    }
  },
  attackBox: {
